    ...
    return [
        {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    options: {
                        type: 'array',
                        description: 'The 4 possible options to the question with only one being correct.',
                        items: {
                            type: 'object',
...
const tryAgain = (category) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        let result = (_a = completion.choices[0].message.function_call) === null || _a === void 0 ? void 0 : _a.arguments.trim().replace(/(\r\n|\n|\r)/gm, '');
...
const newGame = (category) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const parseForPlayer = (resp) => {
    ...
    let options = (_a = resp.options) === null || _a === void 0 ? void 0 : _a.map((a) => a.option);
    // Additionally remove the answerContext field
    delete resp.answerContext;
    delete resp.keywords;
    return Object.assign(Object.assign({}, resp), { options });
};
module.exports = {
    newGame,
    tryAgain,
